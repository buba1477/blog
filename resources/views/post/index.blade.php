...
@section ('content')
    ...
    <main class="blog">
        <div class="container">
            <h1 class="edica-page-title" data-aos="fade-up">Бложег</h1>
            ...
            <div class="row">
                        ...
                        <div class="row blog-post-row">
                            @foreach($randomPosts as $rpost)
                                <div class="col-md-6 blog-post" data-aos="fade-up">
                                    <div class="blog-post-thumbnail-wrapper">
                                        <img src="{{'storage/' . $rpost->main_img}}" alt="blog post">
                                    </div>
                ...
                <div class="col-md-4 sidebar" data-aos="fade-left">
                    ...
                    <div class="widget widget-post-list">
                        <h5 class="widget-title">Топ посты</h5>
                        <ul class="post-list">
                            @foreach($likesPost as $lpost)
                                <li class="post">
                                    <a href="{{route('post.show', $post->id)}}" class="post-permalink media">
                                        <img src="{{'storage/' . $lpost->main_img}}" alt="blog post">
